...
每次点击 Figma Accelerator，自动完成「网络优化 → 启动 Figma」一条龙。
...
1. 从 [Releases](https://github.com/Experiment9527/Figma-Launcher/releases/latest/download/Figma.dmg) 下载 `Figma加速器.dmg`
2. 双击打开 DMG 文件
...
**Q: 切换 WiFi 后需要重新运行吗？**  
A: 每次通过 Figma Accelerator 启动都会自动重新测速，无需额外操作。
...
最新 DMG 安装包：[Figma加速器.dmg](https://github.com/Experiment9527/Figma-Launcher/releases/latest/download/Figma.dmg)
