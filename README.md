...
1. 从 [Releases](https://github.com/Experiment9527/Figma-Launcher/releases/latest/download/Figma启动器.dmg) 下载 `Figma启动器.dmg`
2. 双击打开 DMG 文件
...
最新 DMG 安装包：[Figma启动器.dmg](https://github.com/Experiment9527/Figma-Launcher/releases/latest/download/Figma启动器.dmg)
